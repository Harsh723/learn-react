  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRDwnOKl41cCXsIRaX8_KTXTWjYXdC6dUmXQ&usqp=CAU"
          height="100px"
          width="150px"
        />
      </div>
  ...
  return (
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      <img
        ...
        height="150px"
        alt="res-logo"
        src={`https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_1340/${cloudinaryImageId}`}
      />
      <h3>{name}</h3>
      <h4>{cuisines.join(", ")}</h4>
